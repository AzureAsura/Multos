...
const AnimatedFeatureSection = () => {
    ...
    return (
        <motion.div 
            ...
            animate="animate"
        >
            {/* Presentation Button with Advanced Animations */}
            <motion.div variants={itemVariants} className="relative">
                <motion.button 
                    className="w-full bg-gradient-to-r from-red-500 to-red-700 text-white font-bold py-4 px-6 rounded-full relative overflow-hidden group"
