...
import { slides, heroItems } from '../constants'

const LeftHero = () => {
    return (
        <div className="col-span-12 lg:col-span-8 p-4 md:p-8">
            <div className='flex flex-col items-center text-center'>
                ...
                <div className='px-3'>
                    ...
                    <div className='mt-7 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-200 whitespace-nowrap'>
                ...
                <div className="space-y-3 mt-9">
                    <div className="flex justify-center">
                        <button className="w-[300px]  sm:min-w-[450px] bg-green-300 hover:bg-green-400 text-black font-semibold py-2 px-6 rounded-3xl transition-all transform hover:scale-[1.02] flex items-center justify-center space-x-2 hover:shadow-lg">
                            <span>Google Login</span>
                        </button>
                    </div>
                    <div className="flex justify-center">
                        <button className="w-full  sm:min-w-[450px] bg-gray-100 hover:bg-gray-200 text-black font-semibold py-2 px-6 rounded-3xl transition-all transform hover:scale-[1.02] flex items-center justify-center hover:shadow-lg">
